...
const Guide = () => {
  return (
    <section className="flexCenter flex-col">
      ...
      <div className="flexCenter max-container relative w-full px-7">
        <Image
          src="/boat.png"
          alt="boat"
          width={1440}
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              <div className="flexBetween w-full gap-5">
                ...
                <p className="bold-16 text-green-50">5hr 48min</p>
              </div>
            ...
            <div className="flex w-full flex-col">
              ...
              <h4 className="bold-20 mt-2 whitespace-nowrap">Galle</h4>
            </div>
          </div>
        </div>
      </div>
